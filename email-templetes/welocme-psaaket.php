      ...
      <table width="100%" style="max-width:650px;margin:0 auto"> 
       <tbody>
        <tr> 
         ...
         <td style="width:100%;text-align:center;color:#fff;font-family:'Roboto-Medium',sans-serif;font-size:25px;font-style:normal;font-stretch:normal;padding-right:16px"> <b>Thanks for Registration</b> </td> 
        </tr> 
       </tbody>
      </table> </td> 
    </tr> 
               ...
               <tbody> 
                <tr> 
                 <td  align="left" style="float:right;padding:0;text-align:center;vertical-align:middle">
					<a  href="http://psaaket.com/">
                          <img src="http://psaaket.com/assets/img/logo.png" alt="PSAAKET" class="img-responsive" width="150px">
                        </a>
				 </td> 
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="table-layout:fixed;border-spacing:0;border-collapse:collapse;width:100%;border:none;margin-bottom:24px;margin-right:30px"> 
               <tbody>
                <tr> 
				 ...
				 <p style="padding:0;margin:0;font-size:16px;font-family:'Roboto-Medium',sans-serif;color:#212121">Greetings from psaaket!</p> 
