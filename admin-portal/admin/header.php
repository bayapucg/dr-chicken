	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="dashboard.php" class="logo">
				<!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><b>D</b>C</span>
				<!-- logo for regular state and mobile devices --> <span class="logo-lg"><b>Dr</b>Chicken</span>
			</a>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
						...
						<ul class="treeview-menu" style="display: none;">
							<li> <a href="add_seller.php">Add Seller</a>
							</li>
							<li><a href="seller_list.php">Seller List</a>
							</li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#"> <i class="fa fa-user-plus"></i>  <span> DeliveryBoy</span>
							<span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
						</a>
						<ul class="treeview-menu" style="display: none;">
							<li> <a href="add_deliveryboy.php">Add DeliveryBoy</a>
							</li>
							<li><a href="deliveryboy_list.php">DelivaryBoy List</a>
							</li>
						</ul>
					</li>
					<li class="treeview">
