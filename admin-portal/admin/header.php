...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="dashboard.php" class="logo">
      ...
      <span class="logo-lg"><b>Dr</b>Chicken</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview">
          <a href="#">
            <i class="fa fa-user-plus"></i> <span> Seller</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-user-plus"></i> <span> DeliveryBoy</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         <ul class="treeview-menu" style="display: none;">
            <li>
              <a href="add_deliveryboy.php">Add DeliveryBoy</a>
            </li>
            <li><a href="deliveryboy_list.php">DelivaryBoy List</a></li>
          </ul>
